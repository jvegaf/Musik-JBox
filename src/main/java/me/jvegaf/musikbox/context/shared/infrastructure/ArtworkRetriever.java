package me.jvegaf.musikbox.context.shared.infrastructure;
...
public class ArtworkRetriever {
    ...
    public Artwork retrieve(String location) throws
        ...
        return new Artwork(
                ...
                tag.getFirstArtwork().getDescription(),
                tag.getFirstArtwork().getImageUrl(),
                tag.getFirstArtwork().isLinked(),
                tag.getFirstArtwork().getMimeType(),
                tag.getFirstArtwork().getPictureType()
        );
    }
}
