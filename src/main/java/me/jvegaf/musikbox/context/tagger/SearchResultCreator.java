...
public final class SearchResultCreator {

    public SearchResultCreator() { }

    public List<SearchResult> getResultsFromResponse(String response) {
    ...
    private SearchResult getSearchResult(JsonObject trackObj) {
