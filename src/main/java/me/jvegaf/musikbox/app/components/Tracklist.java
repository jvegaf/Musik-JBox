...
public class Tracklist extends AnchorPane implements Initializable {
    ...
    @Inject public Tracklist(OldTracksRepository repository, CommandBus commandHandler) {
        this.oldTracksRepository = repository;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        this.songsTableView.setItems(this.oldTracksRepository.tracksObjectProperty().getValue());

        this.oldTracksRepository.tracksObjectProperty()
