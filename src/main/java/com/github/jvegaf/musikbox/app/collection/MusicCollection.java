package com.github.jvegaf.musikbox.app.collection;
...
import com.github.jvegaf.musikbox.context.trackplaylist.application.search.SearchAllTracksInPlaylistQuery;
import com.github.jvegaf.musikbox.context.tracks.application.TracksResponse;
import com.github.jvegaf.musikbox.context.tracks.application.find.FindTrackQuery;
import com.github.jvegaf.musikbox.context.tracks.application.search_all.SearchAllTracksQuery;
...
public final class MusicCollection {
    ...
    private void requestTracksOnLibrary() {
        ...
        collectionTracksCount.set(response.tracks()
                                          .size());
    }
