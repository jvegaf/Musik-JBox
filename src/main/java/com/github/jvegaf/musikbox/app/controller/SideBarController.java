...
import com.github.jvegaf.musikbox.context.playlists.application.create.CreatePlaylistCommand;
import com.github.jvegaf.musikbox.context.playlists.application.find.FindPlaylistQuery;
import com.github.jvegaf.musikbox.context.playlists.application.search_all.SearchAllPlaylistsQuery;
import com.github.jvegaf.musikbox.context.playlists.application.update.UpdatePlaylistCommand;
import com.github.jvegaf.musikbox.context.trackplaylist.application.create.CreateTrackPlaylistCommand;
...
import static com.github.jvegaf.musikbox.app.controller.TracklistController.SERIALIZED_MIME_TYPE;
...
public class SideBarController {
    ...
    public void initialize() {
        ...
        playlistListView.setCellFactory(param -> {
            ...
            cell.setOnDragDropped(event -> {
                if (!cell.isEmpty()) {
                    ...
                    ArrayList<String>
                            trackIds =
                            (ArrayList<String>) event.getDragboard()
        ...
        playlistListView.setOnEditCommit(t -> {
            ...
            commandBus.dispatch(new UpdatePlaylistCommand(t.getNewValue()
                                                           .id(),
                                                          t.getNewValue()
                                                           .name()));
        });
